...
public class GameLogic  {
    ...
    public List<Character> gussedLetters; // = new ArrayList<>;
    public List<Character> missedLetters; // = new ArrayList<>;
     ...
     */
    public String GetGuess (){  //This method will ask for nee letter from the palyer and returns this letter.
     ...
     */
    public boolean CompareGuess (Character guessLetter, List<Character> currentWord){ //This method compares between the new letter and check if its exist in the hidden word
